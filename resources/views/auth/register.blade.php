...
<main class="mt-0 main-content">
  <div class="pt-5 page-header align-items-start min-vh-50 pb-11"
    style="background-image: url('https://raw.githubusercontent.com/creativetimofficial/public-assets/master/argon-dashboard-pro/assets/img/signup-cover.jpg'); background-position: top;">
    <span class="mask bg-gradient-dark opacity-6"></span>
    <div class="container">
      <div class="row justify-content-center">
        <div class="mx-auto text-center col-lg-5">
          <h1 class="my-3 text-white">Welcome!</h1>
            ...
            <form method="POST" action="{{ route('register.perform') }}">
              ...
              <div class="flex flex-col mb-3">
                <input type="text" name="username" class="form-control" placeholder="Username" aria-label="Name"
                  value="{{ old('username') }}">
                @error('username') <p class='pt-1 text-xs text-danger'> {{ $message }} </p> @enderror
              </div>
              <div class="flex flex-col mb-3">
